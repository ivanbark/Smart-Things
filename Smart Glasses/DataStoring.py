...
def data_store():
    ...
    # creating table
    stmt = 'CREATE TABLE IF NOT EXISTS image_data (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, time_date VARCHAR(255), image_path VARCHAR(255), temp DOUBLE);'
    cur.execute(stmt)
    ...
    for root, dirs, files in os.walk(os.path.abspath("Images/")):
        for file in files:
            ...
            stmt = 'INSERT INTO `image_data` (time_date, image_path, temp) VALUES (%s, %s, %s);'
            val = (time, image_path, temp)
